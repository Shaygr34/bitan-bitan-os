...
export async function POST(
  ...
  try {
    ...
    console.error(`POST /api/content-factory/articles/${articleId}/assets failed:`, e);
    return errorJson(500, "INTERNAL_ERROR", "Failed to create asset");
  }
}
...
export async function GET(
  ...
  try {
    ...
    console.error(`GET /api/content-factory/articles/${articleId}/assets failed:`, e);
    return errorJson(500, "INTERNAL_ERROR", "Failed to load assets");
  }
}
